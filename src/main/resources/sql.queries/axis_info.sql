select
    jsonb_build_object('label', label, 'quotient', jsonb_build_array(numerator_uuid, denominator_uuid),
...
where
      ba.numerator_uuid = bi1.internal_id
  and ba.denominator_uuid = bi2.internal_id
  and bi1.state = 'READY'
  and bi2.state = 'READY'
  and bi1.is_public
  and bi2.is_public
