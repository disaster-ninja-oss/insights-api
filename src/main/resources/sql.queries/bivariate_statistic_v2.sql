    ...
    jsonb_build_object(
                       ...
                       'indicators', (
                           select jsonb_agg(jsonb_build_object('name', bi.param_id,
                                                               ...
                                                               'layer_spatial_res', bi.layer_spatial_res,
                                                               'layer_temporal_ext', bi.layer_temporal_ext,
             ...
             'layer_spatial_res', bix1.layer_spatial_res,
             'layer_temporal_ext', bix1.layer_temporal_ext,
             'category', bix1.category,
             ...
             'layer_spatial_res', bix2.layer_spatial_res,
             'layer_temporal_ext', bix2.layer_temporal_ext,
             'category', bix2.category,
             ...
             'layer_spatial_res', biy1.layer_spatial_res,
             'layer_temporal_ext', biy1.layer_temporal_ext,
             'category', biy1.category,
             ...
             'layer_spatial_res', biy2.layer_spatial_res,
             'layer_temporal_ext', biy2.layer_temporal_ext,
             'category', biy2.category,
